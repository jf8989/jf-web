// src/components/projectDataTemplate.ts
// Purpose: Structured data template for web development project proposals
// cspell:disable
...
export const projectDataTemplate = {
  ...
  nextSteps: {
    immediateActions: [
      ...
      "Provide logo files or start logo design",
